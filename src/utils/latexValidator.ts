...
export class LatexValidator {
  ...
  private static removeAIArtifacts(content: string): string {
    ...
    // Fix French character encoding issues commonly generated by AI
    const encodingFixes: Array<[RegExp, string]> = [
      ...
      [/\\"\{o\}/g, 'ö'],
      [/\\"\{u\}/g, 'ü'],
      // Fix common LaTeX encoding artifacts
      [/2\\`\{e\}/g, '2ème'],
      [/1\\`\{e\}r/g, '1er'],
      [/Ann\\\'\{e\}e/g, 'Année'],
      [/\\\'\{E\}/g, 'É'],
      [/\\\'\{e\}cole/g, 'École'],
      [/math\\\'\{e\}matiques/g, 'mathématiques'],
      [/g\\\'\{e\}om\\\'\{e\}trie/g, 'géométrie'],
      [/alg\\`\{e\}bre/g, 'algèbre'],
      [/\\\'\{e\}l\\`\{e\}ve/g, 'élève'],
      [/\\\'\{e\}tudiant/g, 'étudiant']
    ];
